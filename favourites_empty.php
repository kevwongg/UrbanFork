	...
	<div class="jumbotron">
		...
		<p><a class="btn btn-primary btn-lg" href="http://localhost/urbanfork/search.php" role="button">Add Favourites</a>
	...
	<div class="container">   
	      <div id="wrapper">
	    	<div id ="columns">
	    			...
	    			$query = "SELECT lf.listid, lf.listname FROM listoffavourites lf WHERE listid NOT IN (SELECT m.listid FROM maintains m WHERE m.id = $userId)";
